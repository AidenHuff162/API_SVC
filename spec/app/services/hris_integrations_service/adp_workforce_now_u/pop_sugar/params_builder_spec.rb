...
RSpec.describe HrisIntegrationsService::AdpWorkforceNowU::PopSugar::ParamsBuilder do
  ...
  describe '#update_adp_from_sapling' do
    it 'should update ADP from Sapling' do
      data = HrisIntegrationsService::AdpWorkforceNowU::PopSugar::DataBuilder.new('US').build_applicant_onboard_data(user, adp_us)
      params = HrisIntegrationsService::AdpWorkforceNowU::PopSugar::ParamsBuilder.new.build_applicant_onboard_params(data)
