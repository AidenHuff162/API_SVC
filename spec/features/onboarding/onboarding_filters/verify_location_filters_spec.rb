...
feature 'Onboarding Dashboard', type: :feature, js: true do
  ...
  scenario 'Verify Location Filters' do
    navigate_to_dashboard
    verify_users_count_on_dashboard
    filter_users_by_location('All Locations','America')
    filter_users_by_location('America','France')
    filter_users_by_location('France','Hyderabad')
    filter_users_by_location('Hyderabad','Lahore')
    filter_users_by_location('Lahore','London')
    filter_users_by_location('London','Paris')
  end
end
