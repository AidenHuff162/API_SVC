...
feature 'SSO Management', type: :feature, js: true do
  ...
  describe 'one_login_SSO' do
    scenario 'Allow sign in with password and one_login_sso' do
      naviagete_to_integrations
      enable_one_login_sso
      ...
      check_sso_management_after_disabling_one_login_sso_integration
      sign_out
      check_login_page_for_password_only
    end

    scenario 'Allow sign in with one_login_sso only' do
      naviagete_to_integrations
      enable_one_login_sso
      navigate_to_platform
      navigate_to_sso
      select_sso_only
      sign_out
      check_login_page_for_one_login_only
      sign_out
      check_login_page_for_password_and_one_login_sso
      check_email_format
      check_inactive_user
