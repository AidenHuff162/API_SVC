...
feature 'transitions', type: :feature, js: true do
  ...
  describe 'Steps to check transitions dashboard' do
    ...
    scenario 'Assign documents to active user and delete some documents' do
      ...
      navigate_to_active_user_assigned_documents
      delete_document
      navigate_to_transition_dashboard
      verify_documents_after_deletion
    end

    scenario 'Assign documents to active user and complete all tasks' do
      navigate_to_active_user_documents
      assign_documents
      navigate_to_transition_dashboard
      transition_action_complete_all_tasks_for_documents
    end

    scenario 'Assign documents to active user and delete hire' do
      navigate_to_active_user_documents
      assign_documents
      navigate_to_transition_dashboard
