module PaperworkRequestSerializer
  class Basic < ActiveModel::Serializer
    attributes :id, :hellosign_signature_id, :hellosign_signature_request_id, :hellosign_claim_url,
      ...
      :description, :co_signer_id, :paperwork_packet_type, :send_completion_email, :co_signer_type, :state
    has_one :document, serializer: DocumentSerializer::Full
    has_one :paperwork_packet, serializer: PaperworkPacketSerializer::Description
    has_one :paperwork_packet_deleted, serializer: PaperworkPacketSerializer::Description
    ...
    def description
      object.document.description if object.id
    end
    ...
    def unsigned_document_url
      if ( is_assigned || ( object.co_signer_id && is_signed )) && object.unsigned_document
