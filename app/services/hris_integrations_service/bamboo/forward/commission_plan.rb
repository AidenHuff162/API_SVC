class HrisIntegrationsService::Bamboo::Forward::CommissionPlan
  attr_reader :company
  ...
  def fetch(bamboo_id, table_name ='customCommissionPlan')
    execute_tabular_data_fetch(table_name, bamboo_id)
  end

  def create_or_update(action, bamboo_id, params, table_name='customCommissionPlan')
