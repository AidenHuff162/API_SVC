class HrisIntegrationsService::Bamboo::Forward::CustomLevel
  attr_reader :company
  ...
  def fetch(bamboo_id, table_name ='customLevel1')
    execute_tabular_data_fetch(table_name, bamboo_id)
  end

  def create_or_update(action, bamboo_id, params, table_name='customLevel1')
