class HrisIntegrationsService::Bamboo::Forward::BonusPlan
  attr_reader :company
  ...
  def fetch(bamboo_id, table_name ='customBonusPlan')
    execute_tabular_data_fetch(table_name, bamboo_id)
  end

  def create_or_update(action, bamboo_id, params, table_name='customBonusPlan')
