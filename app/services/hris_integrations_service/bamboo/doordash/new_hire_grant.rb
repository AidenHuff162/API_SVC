class HrisIntegrationsService::Bamboo::Doordash::NewHireGrant
  attr_reader :company
  ...
  def fetch(bamboo_id, table_name ='customNewHireGrants')
    execute_tabular_data_fetch_custom(table_name, bamboo_id)
  end

  def create_or_update(action, bamboo_id, params, table_name='customNewHireGrants')
