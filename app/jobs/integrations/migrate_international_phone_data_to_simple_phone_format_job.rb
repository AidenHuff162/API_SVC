module Integrations
  class MigrateInternationalPhoneDataToSimplePhoneFormatJob < ApplicationJob
    ...
    def perform(company_id = nil, custom_field_id = nil)
      ...
      CustomFieldsService.new(company).migrate_international_phone_data_to_simple_phone_format(custom_field)
    end
  end
end
