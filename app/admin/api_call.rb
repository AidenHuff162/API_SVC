ActiveAdmin.register Logging, as: "Legacy Logging" do

  menu label: "Outbound", parent: "Legacy Logging", priority: 0
  ...
  controller do
    def scoped_collection
      end_of_association_chain.where.not(action: ['Assign Values To User - Pass', 'Assign Values To User - Fail', 'cancel-offboarding', 'Deduct Balance', 'PTO Calculations', 'TenantDeletion', 'Auto Complete', 'File Attachment', 'Template Issue', 'Create Email', 'Slack PTO Creation', 'Auto Approving Request'])
    end
  end
