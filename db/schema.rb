...
ActiveRecord::Schema.define(version: 2023_02_09_075941) do
  ...
  create_table "active_admin_loggings", id: :serial, force: :cascade do |t|
  ...
  create_table "adp_subscription_users", id: :serial, force: :cascade do |t|
  ...
  create_table "adp_subscriptions", id: :serial, force: :cascade do |t|
    t.string "event_type"
  ...
  create_table "anonymized_data", id: :serial, force: :cascade do |t|
    t.integer "user_id"
    t.json "user_data"
    t.json "address_data"
    t.json "phone_data"
  ...
  create_table "api_keys", id: :serial, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.integer "integration_credential_id"
    t.integer "api_key_type", default: 0
  ...
  create_table "api_loggings", id: :serial, force: :cascade do |t|
    t.integer "company_id"
    t.string "api_key"
    t.string "end_point"
    t.json "data"
  ...
  create_table "approval_chains", id: :serial, force: :cascade do |t|
  ...
  create_table "assigned_pto_policies", id: :serial, force: :cascade do |t|
    ...
    t.float "initial_carryover_balance"
    t.string "env_migration"
  ...
  create_table "billings", force: :cascade do |t|
    ...
    t.index ["company_id"], name: "index_billings_on_company_id"
  end
  ...
  create_table "calendar_feeds", id: :serial, force: :cascade do |t|
  ...
  create_table "companies", id: :serial, force: :cascade do |t|
    ...
    t.boolean "sa_disable", default: true
    t.boolean "enable_custom_table_approval_engine", default: false
    t.string "encrypted_webhook_token"
    t.string "encrypted_webhook_token_iv"
    t.integer "company_plan", default: 0
  ...
  create_table "company_emails", id: :serial, force: :cascade do |t|
    t.string "from"
  ...
  create_table "company_links", id: :serial, force: :cascade do |t|
    t.string "name"
    t.string "link"
    t.integer "position"
    t.integer "company_id"
  ...
  create_table "company_values", id: :serial, force: :cascade do |t|
    t.string "name", null: false
  ...
  create_table "cs_approval_chains", force: :cascade do |t|
  ...
  create_table "ctus_approval_chains", id: :serial, force: :cascade do |t|
    t.integer "approval_chain_id"
  ...
  create_table "custom_email_alerts", id: :serial, force: :cascade do |t|
    t.integer "company_id"
  ...
  create_table "custom_field_reports", id: :serial, force: :cascade do |t|
    t.integer "report_id"
    t.integer "custom_field_id"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "custom_field_values", id: :serial, force: :cascade do |t|
    ...
    t.index ["user_id", "sub_custom_field_id", "deleted_at"], name: "index_cfv_on_sub_custom_field_values_and_users", unique: true
  ...
  create_table "custom_fields", id: :serial, force: :cascade do |t|
    ...
    t.bigint "custom_section_id"
    t.index ["company_id"], name: "index_custom_fields_on_company_id"
    t.index ["custom_section_id"], name: "index_custom_fields_on_custom_section_id"
  ...
  create_table "custom_section_approvals", force: :cascade do |t|
  ...
  create_table "custom_sections", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["company_id"], name: "index_custom_sections_on_company_id"
  end

  create_table "custom_snapshots", id: :serial, force: :cascade do |t|
    t.integer "custom_field_id"
  ...
  create_table "custom_table_user_snapshots", id: :serial, force: :cascade do |t|
    t.integer "custom_table_id"
    t.integer "user_id"
    t.integer "edited_by_id"
    t.datetime "created_at", null: false
  ...
  create_table "deleted_user_emails", id: :serial, force: :cascade do |t|
    t.string "email"
  ...
  create_table "document_connection_relations", id: :serial, force: :cascade do |t|
    t.string "title"
  ...
  create_table "document_upload_requests", id: :serial, force: :cascade do |t|
    t.integer "company_id"
    ...
    t.index ["updated_by_id"], name: "index_document_upload_requests_on_updated_by_id"
  ...
  create_table "email_templates", id: :serial, force: :cascade do |t|
    ...
    t.jsonb "schedule_options", default: {"to"=>nil, "due"=>nil, "date"=>nil, "from"=>nil, "time"=>nil, "duration"=>nil, "time_zone"=>nil, "send_email"=>0, "relative_key"=>nil, "duration_type"=>nil, "set_onboard_cta"=>false}
  ...
  create_table "field_histories", id: :serial, force: :cascade do |t|
    t.string "field_name"
    t.text "new_value"
    ...
    t.bigint "integration_instance_id"
    t.string "env_migration"
    ...
    t.index ["integration_instance_id"], name: "index_field_histories_on_integration_instance_id"
  end

  create_table "general_data_protection_regulations", id: :serial, force: :cascade do |t|
    t.integer "edited_by_id"
  ...
  create_table "google_credentials", id: :serial, force: :cascade do |t|
    t.json "credentials"
  ...
  create_table "hellosign_calls", force: :cascade do |t|
    ...
    t.json "hellosign_bulk_response_status", default: {}
  ...
  create_table "history_users", id: :serial, force: :cascade do |t|
  ...
  create_table "integration_configurations", force: :cascade do |t|
    ...
    t.bigint "integration_inventory_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.jsonb "dropdown_options"
    t.index ["integration_inventory_id"], name: "index_integration_configurations_on_integration_inventory_id"
  end
  ...
  create_table "integration_credentials", force: :cascade do |t|
    ...
    t.string "name"
    t.bigint "integration_instance_id"
    t.bigint "integration_configuration_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.jsonb "dropdown_options"
    t.string "env_migration"
    t.index ["integration_configuration_id"], name: "index_integration_credentials_on_integration_configuration_id"
    t.index ["integration_instance_id"], name: "index_integration_credentials_on_integration_instance_id"
  end

  create_table "integration_error_slack_webhooks", id: :serial, force: :cascade do |t|
    t.string "channel"
    ...
    t.string "company_name"
    t.integer "configure_app", default: 0
  end

  create_table "integration_field_mappings", force: :cascade do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.jsonb "integration_selected_option"
    t.string "env_migration"
    t.index ["company_id"], name: "index_integration_field_mappings_on_company_id"
    t.index ["custom_field_id"], name: "index_integration_field_mapping_on_custom_field_id"
    t.index ["integration_field_key", "custom_field_id", "integration_instance_id", "field_position"], name: "uniqueness_validator", unique: true
    t.index ["integration_instance_id"], name: "index_integration_field_mapping_on_integration_instance_id"
    t.index ["integration_instance_id"], name: "index_integration_field_mappings_on_integration_instance_id"
  end

  create_table "integration_instances", force: :cascade do |t|
    t.json "filters"
    t.json "actions"
    ...
    t.datetime "deleted_at"
    t.index ["company_id"], name: "index_integration_instances_on_company_id"
    t.index ["connected_by_id"], name: "index_integration_instances_on_connected_by_id"
    t.index ["deleted_at"], name: "index_integration_instances_on_deleted_at"
    t.index ["integration_inventory_id"], name: "index_integration_instances_on_integration_inventory_id"
  end

  create_table "integration_inventories", force: :cascade do |t|
    t.string "display_name", null: false
    t.integer "status", null: false
    t.integer "category", null: false
    t.string "knowledge_base_url"
    t.integer "data_direction"
    t.boolean "enable_filters", default: false, null: false
    t.boolean "enable_test_sync", default: false, null: false
    t.integer "state", default: 1, null: false
    t.integer "position", default: 0, null: false
    t.boolean "enable_multiple_instance", default: false, null: false
    t.string "api_identifier", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.boolean "enable_authorization", default: false
    t.boolean "enable_connect", default: false
    t.integer "field_mapping_option"
    t.integer "field_mapping_direction"
    t.string "mapping_description"
  end
  ...
  create_table "integrations", id: :serial, force: :cascade do |t|
    ...
    t.boolean "enable_tax_type", default: false
    t.boolean "sync_preferred_name", default: false
    t.index ["company_id"], name: "index_integrations_on_company_id"
  end

  create_table "inventory_field_mappings", force: :cascade do |t|
    t.string "inventory_field_key"
    t.string "inventory_field_name"
    t.bigint "integration_inventory_id"
    t.jsonb "integration_mapping_options"
    t.index ["integration_inventory_id"], name: "index_inventory_field_mappings_on_integration_inventory_id"
  end
  ...
  create_table "loggings", id: :serial, force: :cascade do |t|
    t.integer "integration_id"
    t.string "action"
    t.json "result"
    t.datetime "created_at", null: false
  ...
  create_table "monthly_active_user_histories", force: :cascade do |t|
  ...
  create_table "organization_charts", id: :serial, force: :cascade do |t|
  ...
  create_table "paperwork_packet_connections", id: :serial, force: :cascade do |t|
  ...
  create_table "paperwork_packets", id: :serial, force: :cascade do |t|
    t.string "name", null: false
    t.string "description"
    t.integer "company_id"
    t.datetime "created_at", null: false
    ...
    t.index ["updated_by_id"], name: "index_paperwork_packets_on_updated_by_id"
    t.index ["user_id"], name: "index_paperwork_packets_on_user_id"
  end

  create_table "paperwork_requests", id: :serial, force: :cascade do |t|
    t.integer "user_id"
    ...
    t.integer "co_signer_type"
    t.boolean "uploaded_to_bamboo", default: false
    t.string "email_status"
    t.datetime "hellosign_modal_opened_at"
    t.string "env_migration"
  ...
  create_table "paperwork_templates", id: :serial, force: :cascade do |t|
    t.integer "document_id"
    ...
    t.index ["updated_by_id"], name: "index_paperwork_templates_on_updated_by_id"
    t.index ["user_id"], name: "index_paperwork_templates_on_user_id"
  end

  create_table "pending_hires", id: :serial, force: :cascade do |t|
    t.string "first_name"
    t.string "last_name"
    t.string "title"
    t.string "personal_email"
  ...
  create_table "policy_tenureships", id: :serial, force: :cascade do |t|
    t.integer "pto_policy_id"
    t.integer "year"
    t.float "amount"
    t.datetime "created_at", null: false
  ...
  create_table "profile_template_custom_field_connections", force: :cascade do |t|
  ...
  create_table "profile_template_custom_table_connections", force: :cascade do |t|
    t.bigint "profile_template_id"
  ...
  create_table "pto_adjustments", id: :serial, force: :cascade do |t|
    t.float "hours"
    t.integer "operation"
    t.string "description"
    t.date "effective_date"
  ...
  create_table "pto_balance_audit_logs", id: :serial, force: :cascade do |t|
    t.integer "assigned_pto_policy_id"
    t.date "balance_updated_at"
  ...
  create_table "pto_policies", id: :serial, force: :cascade do |t|
    t.string "name"
    t.integer "company_id"
    ...
    t.boolean "has_stop_accrual_date", default: false
    t.float "stop_accrual_date", default: 0.0
    t.integer "position", default: 0
    t.index ["company_id"], name: "index_pto_policies_on_company_id"
    t.index ["updated_by_id"], name: "index_pto_policies_on_updated_by_id"
  end

  create_table "pto_requests", id: :serial, force: :cascade do |t|
    t.integer "user_id"
    ...
    t.float "carryover_balance_hours", default: 0.0
    t.string "env_migration"
  ...
  create_table "request_informations", id: :serial, force: :cascade do |t|
  ...
  create_table "requested_fields", force: :cascade do |t|
    t.integer "custom_section_approval_id"
    t.integer "custom_field_id"
  ...
  create_table "sftps", force: :cascade do |t|
    t.string "name", null: false
    ...
    t.index ["company_id"], name: "index_sftps_on_company_id"
    t.index ["updated_by_id"], name: "index_sftps_on_updated_by_id"
  end
  ...
  create_table "smart_assignment_configurations", force: :cascade do |t|
    t.jsonb "meta", default: {}
    t.bigint "company_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["company_id"], name: "index_smart_assignment_configurations_on_company_id"
  end
  ...
  create_table "states", id: :serial, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.json "state_codes", default: {}
    t.index ["country_id"], name: "index_states_on_country_id"
  end

  create_table "sub_custom_fields", id: :serial, force: :cascade do |t|
    t.integer "custom_field_id"
    t.string "name"
    t.integer "field_type"
    t.string "help_text"
  ...
  create_table "sub_task_user_connections", id: :serial, force: :cascade do |t|
  ...
  create_table "survey_answers", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.string "selected_user_ids", array: true
    t.string "env_migration"
  ...
  create_table "task_user_connections", id: :serial, force: :cascade do |t|
    t.integer "user_id"
    t.integer "task_id"
    t.string "state"
    t.datetime "created_at", null: false
    ...
    t.integer "dependent_tuc", default: [], array: true
    t.integer "completed_dependent_task_count", default: 0, null: false
    t.string "job_id"
    t.string "service_now_id"
    t.string "env_migration"
  ...
  create_table "tasks", id: :serial, force: :cascade do |t|
    ...
    t.bigint "survey_id"
    t.integer "dependent_tasks", default: [], array: true
    t.string "env_migration"
  ...
  create_table "unassigned_pto_policies", id: :serial, force: :cascade do |t|
    t.integer "user_id"
    t.integer "pto_policy_id"
    t.date "effective_date"
  ...
  create_table "user_document_connections", id: :serial, force: :cascade do |t|
    t.integer "user_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "users", id: :serial, force: :cascade do |t|
    ...
    t.string "trinet_id"
    t.string "slack_id"
    t.string "learn_upon_id"
    t.string "lessonly_id"
    t.boolean "visibility", default: true
    t.string "gusto_id"
    t.string "lattice_id"
    t.datetime "created_at_kallidus"
    t.string "team_spirit_id"
    t.string "temporary_email"
    t.boolean "gsuite_account_deprovisioned", default: false
    t.integer "remove_access_state", default: 0
    t.boolean "is_demo_account_creator", default: false
    t.string "temp_auth_token"
    t.boolean "ui_switcher", default: false
    t.string "identity_server_id"
  ...
  create_table "webhook_events", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["company_id"], name: "index_webhook_events_on_company_id"
    t.index ["triggered_by_id"], name: "index_webhook_events_on_triggered_by_id"
    t.index ["triggered_for_id"], name: "index_webhook_events_on_triggered_for_id"
  ...
  create_table "webhooks", force: :cascade do |t|
    ...
    t.index ["updated_by_id"], name: "index_webhooks_on_updated_by_id"
  end

  create_table "workspace_images", id: :serial, force: :cascade do |t|
    t.string "image"
  ...
  create_table "workstreams", id: :serial, force: :cascade do |t|
    t.integer "company_id"
    t.string "name"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  add_foreign_key "custom_fields", "custom_sections"
  add_foreign_key "custom_sections", "companies"
  ...
  add_foreign_key "field_histories", "integration_instances"
  ...
  add_foreign_key "integration_configurations", "integration_inventories"
  add_foreign_key "integration_credentials", "integration_configurations"
  add_foreign_key "integration_credentials", "integration_instances"
  add_foreign_key "integration_instances", "companies"
  add_foreign_key "integration_instances", "integration_inventories"
  add_foreign_key "integration_instances", "users", column: "connected_by_id"
  add_foreign_key "integrations", "companies"
  add_foreign_key "inventory_field_mappings", "integration_inventories"
  ...
  add_foreign_key "paperwork_packets", "users", column: "updated_by_id"
  ...
  add_foreign_key "sftps", "companies"
  add_foreign_key "sftps", "users", column: "updated_by_id"
  add_foreign_key "smart_assignment_configurations", "companies"
  ...
  add_foreign_key "webhook_events", "companies"
  add_foreign_key "webhook_events", "users", column: "triggered_by_id"
  add_foreign_key "webhook_events", "users", column: "triggered_for_id"
  ...
  add_foreign_key "webhooks", "users", column: "updated_by_id"
